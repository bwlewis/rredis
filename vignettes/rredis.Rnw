...
value. The Redis server can handle lots of small transactions with aplomb,
easily exceeding 50,000 transactions/second even on very limited
hardware\footnote{Redis easily exceeds 100,000 transactions/second on typical
